...
void test_rotateRightAndReBalance_given_20_15_30_35_40_50(void){
    initNode(&node20,NULL,NULL,0);
    ...
    root=rotateRightAndReBalance(&node40);
    TEST_ASSERT_EQUAL_PTR(&node30,root);
...
void test_rotateRightAndReBalance_given_80_30_10_60_90_50(void){
    initNode(&node70,NULL,NULL,0);
    initNode(&node60,&node50,NULL,-1);
    initNode(&node10,NULL,NULL,0);
    initNode(&node30,&node10,&node60,0);
...
void test_rotateLeftAndRebalance_given_20_50_70(void){
    ...
    //Test
    root=rotateLeftAndReBalance(&node20);
    TEST_ASSERT_EQUAL_PTR(&node50,root);
...
void test_rotateLeftAndReBalance_given_25_30_45_40_60_75(void){
    ...
    //Test
    root=rotateLeftAndReBalance(&node30);
...
void test_rotateLeftAndReBalance_given_RL_55_50_25_75_60_80(void){
    initNode(&node80,NULL,NULL,0);
...
void test_rotateLeftAndReBalance_given_RL_65_50_25_75_60_80(void){
    initNode(&node80,NULL,NULL,0);
...
*
**/
void test_rotateLeftAndReBalance_15_30_20(void){
    //Build number tree
    initNode(&node20,NULL,NULL,0);
    initNode(&node30,&node20,NULL,-1);
    ...
    //Test
    root=rotateLeftAndReBalance(&node15);
    TEST_ASSERT_EQUAL_PTR(&node20,root);
